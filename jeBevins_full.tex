...
\address{\href{james.bevins@afit.edu}{james.bevins@afit.edu} \\ (937)~$\cdot$~255~$\cdot$~3636~ext. 4767} % Your phone number and email
...
%----------------------------------------------------------------------------------------
% Add APDP certs and PME
%\begin{rSection}{Professional Education/Training/Certification}
%\input{professional-education}
%\end{rSection}
